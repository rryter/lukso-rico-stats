...
contract ERC734KeyManager is ERC165, IERC1271, AccessControl {
    ...
    function execute(bytes calldata _data) external payable {
        bool isExecutor = hasPrivilege(msg.sender, EXECUTION_KEY) ||
            hasPrivilege(msg.sender, MANAGEMENT_KEY);
    ...
    function setKey(
        ...
        emit KeySet(_key, _purpose, _keyType, _address);
    }
    ...
    function removeKey(bytes32 _key, uint256 i) public onlyManagementKeyOrSelf {
        ...
        emit KeyRemoved(_key, key.purpose, key.keyType, key.keyAddress);
    }
        ...
        returns (bytes4 magicValue)
    {
        ...
        return
            (hasPrivilege(recoveredAddress, EXECUTION_KEY))
